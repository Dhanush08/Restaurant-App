...
const Header = ({cartItems}) => {
  ...
  return (
    <header className="p-4 d-flex flex-row align-items-center justify-content-between nav-header">
      <h1 className="m-0 logo-heading">Shine Cafe</h1>
      <div className="d-flex flex-row align-items-center ms-auto">
        <p className="mt-0 mb-0 me-2 mr-4 d-none d-sm-block my-orders-text">
          My Orders
        </p>
        {renderCartIcon()}
      </div>
